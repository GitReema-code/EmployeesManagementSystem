...
/// </summary>
/// 
namespace EmployeesManagement.App_Code
{
   public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["EmployeeManagementDB"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["EmployeeManagementDB"].ConnectionString);
        public CRUD()
        {
            //
        ...
        public DataTable GetDataTable(string sql, Dictionary<string, object> parameters)
        {
            ...
            using (SqlConnection connection = new SqlConnection()) // Ensure connectionString is correctly set
            {
